...
=== Changes in CodeQualityExtension implementation

The link:{javadocPath}/org/gradle/api/plugins/quality/CodeQualityExtension.html[`CodeQualityExtension`] class now requires a `Project` reference for creation.
Some plugins may extend this class and should be adjusted accordingly.
